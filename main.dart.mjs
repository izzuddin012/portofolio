...
"all",
"Bukalapak",
"iOS app for one of Indonesia's largest marketplaces — serving millions of buyers and sellers.",
"Swift",
"Objective-C",
"UIKit",
...
"MVVM",
"Firebase",
"Shipped \"Nego Cincai\" — a viral price-negotiation feature that became one of Bukalapak's signature social commerce mechanics (2017)",
"Built virtual product purchase flows for mobile top-ups, flight tickets, and train tickets, integrating multiple third-party provider APIs",
"Led migration from Storyboard/XIB to programmatic Autolayout, significantly improving maintainability and layout flexibility at scale",
"Built generic reusable UITableView/UICollectionView components adopted across multiple squads in the iOS codebase",
"Developed and iterated on seller features including product listing, inventory management, and order fulfilment workflows",
...
"Allofresh",
"Consumer-facing Flutter grocery app — built on a clean multi-module architecture migrated from native",
"Dart",
"BLoC",
"Clean Architecture",
"Modularization",
"REST API",
"Led multi-module architecture design during migration from native to Flutter, enabling independent parallel feature delivery across squads",
"Built a network wrapper module that standardized API communication, response parsing, and error handling across all app modules",
"Designed and implemented an impression tracker — capturing which sections users actually see, feeding behavioral data directly into product decisions",
"Managed the full release pipeline: internal testing, staged rollouts, and App Store & Play Store submissions",
...
"PickPack by Allofresh",
"Flutter warehouse operations app — owned end-to-end, driving midmile picking & packing workflows with hardware integrations for barcode scanners and thermal printers.",
"CI/CD",
"Fastlane",
"GitHub Actions",
"Barcode Scanner",
"Thermal Printer",
"Sole owner of the app end-to-end — architecture, features, integrations, and every production release decision",
"Drove three major Flutter SDK migrations (1.x → 2.x → 3.x), keeping the app on stable, modern foundations with zero feature regressions",
"Integrated barcode scanners and thermal printers, equipping warehouse staff with hardware-backed workflows that cut manual steps",
"Built CI/CD pipelines for automated unit testing and static analysis on every pull request, maintaining code quality at scale",
"Resolved persistent data sync issues between packaging and inventory services, improving fulfillment accuracy across warehouse operations",
...
"Kingkong Meats",
"Flutter e-commerce app built from scratch for a specialty meat retailer — covering product browsing, cart, and push notifications, launched on both App Store and Play Store.",
"Contributed to app architecture design from day zero, establishing scalable patterns for the team to build on",
"Built core commerce features: product listing with filters, cart management, and push notification delivery",
"Prepared and launched the app on both App Store and Play Store, handling all submission, compliance, and release requirements",
...
"Devolio",
"Open source web portfolio for developer — built entirely in Flutter Web with clean architecture, Riverpod state management, and GitHub Pages deployment.",
"Flutter Web",
"Riverpod",
"flutter_animate",
"GitHub Pages",
...
"https://github.com/izzuddin012/devolio-flutter",
"https://izzuddin012.github.io/devolio-flutter/",
"Featured Projects",
...
"QUICK INFO",
"Email",
"izzuddin.m012@gmail.com",
"mailto:izzuddin.m012@gmail.com",
"Location",
"Indonesia",
"Status",
...
"https://github.com/izzuddin012",
"https://github.com/",
"GitHub",
"https://linkedin.com/in/izzuddin012",
...
"Senior Mobile Apps Engineer (Flutter)",
"2022 – 2026",
...
"Senior Mobile Apps Engineer (iOS Native, Flutter)",
"2016 – 2022",
...
"Offline Support",
"Deep Linking",
"I'm a Senior Mobile Apps Engineer with over 10 years of experience building high-performance mobile applications across iOS and Flutter. My work spans large-scale e-commerce platforms serving millions of users to real-time operational tools for logistics and supply chain.",
"I specialize in clean architecture, performance optimization, and system-level thinking — taking ownership of both feature delivery and engineering standards. I've served on Flutter and iOS Core Teams, defining shared patterns and driving reliability improvements across the stack.",
"\"Scalable systems, performance optimization, operational excellence — not just buzzwords, but the lens through which every architectural decision gets made.\"",
...
"10+ years building high-performance mobile apps for iOS & Flutter — from large-scale e-commerce\n to real-time logistics systems.",
"= ",
"about",
"About",
"projects",
